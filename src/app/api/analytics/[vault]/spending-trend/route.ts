...
const logger = createLogger({ service: 'api-analytics-trend' })
...
export const GET = async (
    ...
    try {
        ...
        // 4. Fetch Spending Trend
        const data = await analyticsService.getSpendingTrend(vaultId, days)
        ...
        logger.error({ error, vaultId }, 'Failed to get spending trend')
